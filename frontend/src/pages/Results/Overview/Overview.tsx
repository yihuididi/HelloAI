...
const data = {
  score: 15,
  title: 'Beginner',
  description: 'You are clearly understood in all conversations. Time for you to focus on advanced pronunciation skills such as Linkage, the Flap sound and Dropped consonants. Mastering these skills will get you closer to the pronunciation level of a fluent speaker.',
  ...
  return (
    <>
      <div className={`${styles.container} ${styles.score}`}>
        ...
        />
        <h3>Your overall score is <strong>{data.title}</strong>.</h3>
